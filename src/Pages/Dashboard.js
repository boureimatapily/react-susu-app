...
import UserProfile from "../Components/Susu/Profile/UserProfile";
    ...
    <div className="container">
      <div className="row">
          ...
          <div className="col-sm-12 col-xs-12 col-md-3 col-lg-3 col-xl-3 col-xxl-3 mt-3">
            <div className="nav flex-column nav-pills mt-3" id="v-pills-tab allColor" role="tablist" aria-orientation="vertical">
              <a className="nav-link active  userdahnav mt-3" id="v-pills-home-tab" data-toggle="pill" href="#v-pills-home" role="tab" aria-controls="v-pills-home" aria-selected="true">Susu</a>
